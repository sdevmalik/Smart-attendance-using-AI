...
def main():
    ...
    root = Tk()
    root.title("Invigilators Login")
    root.geometry("1920x1080")
    root.state('zoomed')
    
    #Image_open=Image.open("ui/blue.png")
    ...
    photo=PhotoImage(file="ui/invigilator_login.png")
...
def insert():
    ...
    if (user=="" or pas==""):
        ...
        cursor.execute("SELECT * FROM invigilators where invigilator_username='" + user + "'")
    ...
    if flag==1:
        ...
        root.destroy()
        os.system("python invigilator_panel.py")
    else:
